...
import { useTitle, useAddMonthlyRevenues } from "../../../hooks";
import { FaFileExcel } from "react-icons/fa";

export const AddMonthlyRevenues = ({ apiEndPoint }) => {

    const title = "Add Monthly Revenues"
    useTitle(title);

    const [selectedFile, setSelectedFile] = useState(null);
    const { missingPlants, readExcelFile, successfulPosts, unsuccessfulPosts } = useAddMonthlyRevenues(apiEndPoint);
    ...
    return (
        <div>
            <div>
                <h5 className="mb-4">Add Monthly Revenues</h5>
                ...
                <div className="d-flex align-items-center">
                    ...
                    <a
                        href="/files/add_monthly_revenues.xlsx"
                        download="add_monthly_revenues.xlsx"
                    >
                ...
                <div className="d-flex flex-column align-items-start">
                  ...
                  *Do include the start and end data from expenses data also the date format in the Excel file should be set to the default format of MM/DD/YYYY.*
                  </span>
                </div>
            </div>
            <br />
